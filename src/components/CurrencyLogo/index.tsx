...
import { ChainId, Currency, Token, ETHER, FANTOM, BINANCE_COIN, DEFAULT_CURRENCIES, Blockchain } from '@deathswap/sdk'
...
export default function CurrencyLogo({
  ...
  if (currency === ETHER) {
    ...
    if (currency === FANTOM || currency === (wrappedCurrency && blockchain === Blockchain.FANTOM)) {
