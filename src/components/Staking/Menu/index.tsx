    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          ...
          {chainId &&
            [ChainId.FANTOM_TESTNET, ChainId.FANTOM_MAINNET, ChainId.BSC_MAINNET, ChainId.BSC_TESTNET].includes(
              chainId
            ) && (
          ...
          {chainId && [ChainId.FANTOM_TESTNET, ChainId.FANTOM_MAINNET].includes(chainId) && (
