...
import { ChainId, JSBI, Percent, Token, WETH, Fraction } from '@deathswap/sdk'
...
export const PIT_SETTINGS: { [chainId in ChainId]: Record<string, string> } = {
  ...
  [ChainId.FANTOM_MAINNET]: { name: 'ViperPit', path: '/viperPit' },
  [ChainId.FANTOM_TESTNET]: { name: 'ViperPit', path: '/viperPit' }
}
...
export const NEST_SETTINGS: { [chainId in ChainId]: Record<string, string> } = {
  ...
  [ChainId.FANTOM_MAINNET]: { name: 'ViperNest', path: '/single' },
  [ChainId.FANTOM_TESTNET]: { name: 'ViperNest', path: '/single' }
}
...
export const BRIDGE_URLS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: '',
  [ChainId.BSC_TESTNET]: '',
  [ChainId.FANTOM_MAINNET]: 'https://bridge.FANTOM.one',
  [ChainId.FANTOM_TESTNET]: ''
}
...
export const POOL_BACKGROUNDS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_MAINNET]: '#02a2c4',
  [ChainId.FANTOM_TESTNET]: '#02a2c4'
}
...
export const UNLOCKING_STARTS: { [chainId in ChainId]: number | undefined } = {
  ...
  [ChainId.FANTOM_MAINNET]: 22770895,
  [ChainId.FANTOM_TESTNET]: 21195000
}
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.FANTOM_MAINNET]: [WETH[ChainId.FANTOM_MAINNET]],
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.FANTOM_MAINNET]: [
    ...WETH_ONLY[ChainId.FANTOM_MAINNET],
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'BUSD'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, '1DAI'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, '1USDC'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, '1ETH'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'VIPER'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'WAGMI')
  ],
  [ChainId.BSC_MAINNET]: [
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.FANTOM_MAINNET]: [
    ...
    getTokenWithDefault(ChainId.FANTOM_MAINNET, '1ETH'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'VIPER'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'xVIPER'),
    getTokenWithDefault(ChainId.FANTOM_MAINNET, 'WAGMI')
  ],
  [ChainId.BSC_MAINNET]: [
    ...WETH_ONLY[ChainId.BSC_MAINNET],
