...
export const FANTOM_TESTNET_SMART_CHEF_POOLS: Record<string, SmartChefPoolInfo[]> = {
  single: [
    {
      pid: 0,
      order: 0,
      ...
      stakedToken: getTokenWithDefault(ChainId.FANTOM_TESTNET, 'WONE'),
      rewardToken: getTokenWithDefault(ChainId.FANTOM_TESTNET, 'VIPER'),
      rewardPerBlock: '0.05',
      blocks: {
        start: 12296500,
        end: 14888500
  ...
  bridge: [
    {
      ...
      category: 'bridge',
      stakedTokens: getPairTokensWithDefaults(ChainId.FANTOM_TESTNET, 'WONE/1BUSD'),
