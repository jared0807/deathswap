...
import { ChainId, WETH } from '@deathswap/sdk'
...
export function usePitContract(withSignerIfPossible?: boolean): Contract | null {
  return useContract(undefined, PIT_ABI, withSignerIfPossible)
}

export function usePitBreederContract(withSignerIfPossible?: boolean): Contract | null {
  return useContract(undefined, PIT_BREEDER_ABI, withSignerIfPossible)
}
